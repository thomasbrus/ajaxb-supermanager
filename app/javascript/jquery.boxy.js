...
jQuery.extend(Boxy, {
  ...
  DEFAULTS: {
    ...
    closeText: "Sluiten", // text to use for default close link
  ...
  _viewport: function () {
    ...
    return jQuery.extend(
      false ? { left: b.scrollLeft || d.scrollLeft, top: b.scrollTop || d.scrollTop } : { left: w.pageXOffset, top: w.pageYOffset },
