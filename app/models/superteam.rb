class Superteam < ActiveRecord::Base
  ...
  validates_presence_of :goalkeeper_id, :bonus_player_id, :coach_id,
    :defender_a_id, :defender_b_id, :defender_c_id, :defender_d_id,
    :midfielder_a_id, :midfielder_b_id, :midfielder_c_id,
    :forward_a_id, :forward_b_id, :forward_c_id
end
